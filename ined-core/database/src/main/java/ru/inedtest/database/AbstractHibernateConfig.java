...
@EnableJpaRepositories(basePackages = "ru.inedtest.dbtools.repositories", entityManagerFactoryRef = "entityManagerFactoryBean")
public abstract class AbstractHibernateConfig {


    private static final String ENTITY_PACKAGE = "ru.inedtest.dbtools.domains";
